...
# metadata
metadata = {
    "protocolName": "20241001 OT2 Georg PhD Replciation Protocol_v3.3",
...
A1.1,B4.1,C6.1,A1.1,Single,eYFPG5A,85.1,300

A2.1,B5.1,D1.1,A2.1,Single,mKO2,50,300

A3.1,B6.1,D2.1,A3.1,Single,tagBFP,100,300

A1.1,C1.1,D3.1,A4.1,Co,eYFPG5A,85.1,166.6666667

A2.1,C1.1,D3.1,A4.1,Co,mKO2,50,166.6666667

A3.1,C1.1,D3.1,A4.1,Co,tagBFP,100,166.6666667

A4.1,C2.1,D4.1,B1.1,Co,0u+ to 1u- : epegRNA (pGW0060),56.4,100

A5.1,C2.1,D4.1,B1.1,Co,PEmax,50,300

A6.1,C2.1,D4.1,B1.1,Co,2ndary cut,50,100

A2.1,C2.1,D4.1,B1.1,Co,mKO2,50,100

B1.1,C3.1,D5.1,B2.1,Co,1u- to 1u+ : epegRNA (pGW0069),65.6,100

A5.1,C3.1,D5.1,B2.1,Co,PEmax,50,300

A6.1,C3.1,D5.1,B2.1,Co,2ndary cut,50,100

A2.1,C3.1,D5.1,B2.1,Co,mKO2,50,100

B2.1,C4.1,D6.1,B3.1,Co,1u+ to 0u- : epegRNA (pGW0067),60.8,100

A5.1,C4.1,D6.1,B3.1,Co,PEmax,50,300

A6.1,C4.1,D6.1,B3.1,Co,2ndary cut,50,100

A2.1,C4.1,D6.1,B3.1,Co,mKO2,50,100

B3.1,C5.1,A1.2,B4.1,Co,0u- to 0u+ : epegRNA (pGW0070),52.7,100

A5.1,C5.1,A1.2,B4.1,Co,PEmax,50,300

A6.1,C5.1,A1.2,B4.1,Co,2ndary cut,50,100

A2.1,C5.1,A1.2,B4.1,Co,mKO2,50,100

A1.1,B4.1,C6.1,A1.2,Single,eYFPG5A,85.1,300

A2.1,B5.1,D1.1,A2.2,Single,mKO2,50,300

A3.1,B6.1,D2.1,A3.2,Single,tagBFP,100,300

A1.1,C1.1,D3.1,A4.2,Co,eYFPG5A,85.1,166.6666667

A2.1,C1.1,D3.1,A4.2,Co,mKO2,50,166.6666667

A3.1,C1.1,D3.1,A4.2,Co,tagBFP,100,166.6666667

A4.1,C2.1,D4.1,B1.2,Co,0u+ to 1u- : epegRNA (pGW0060),56.4,100

A5.1,C2.1,D4.1,B1.2,Co,PEmax,50,300

A6.1,C2.1,D4.1,B1.2,Co,2ndary cut,50,100

A2.1,C2.1,D4.1,B1.2,Co,mKO2,50,100

B1.1,C3.1,D5.1,B2.2,Co,1u- to 1u+ : epegRNA (pGW0069),65.6,100

A5.1,C3.1,D5.1,B2.2,Co,PEmax,50,300

A6.1,C3.1,D5.1,B2.2,Co,2ndary cut,50,100

A2.1,C3.1,D5.1,B2.2,Co,mKO2,50,100

B2.1,C4.1,D6.1,B3.2,Co,1u+ to 0u- : epegRNA (pGW0067),60.8,100

A5.1,C4.1,D6.1,B3.2,Co,PEmax,50,300

A6.1,C4.1,D6.1,B3.2,Co,2ndary cut,50,100

A2.1,C4.1,D6.1,B3.2,Co,mKO2,50,100

B3.1,C5.1,A1.2,B4.2,Co,0u- to 0u+ : epegRNA (pGW0070),52.7,100

A5.1,C5.1,A1.2,B4.2,Co,PEmax,50,300

A6.1,C5.1,A1.2,B4.2,Co,2ndary cut,50,100

A2.1,C5.1,A1.2,B4.2,Co,mKO2,50,100

A2.2,A3.2,A4.2,A5.1,Single,Transfection control,500,500

A2.2,A3.2,A4.2,A5.2,Single,Transfection control,500,500

A5.1,A5.2,A6.2,C1.1,Co,PEmax,50,300

A6.1,A5.2,A6.2,C1.1,Co,2ndary cut,50,100

A2.1,A5.2,A6.2,C1.1,Co,mKO2,50,100

A5.1,A5.2,A6.2,C2.1,Co,PEmax,50,300

A6.1,A5.2,A6.2,C2.1,Co,2ndary cut,50,100

A2.1,A5.2,A6.2,C2.1,Co,mKO2,50,100

A5.1,A5.2,A6.2,C3.1,Co,PEmax,50,300

A6.1,A5.2,A6.2,C3.1,Co,2ndary cut,50,100

A2.1,A5.2,A6.2,C3.1,Co,mKO2,50,100

A5.1,A5.2,A6.2,C4.1,Co,PEmax,50,300

A6.1,A5.2,A6.2,C4.1,Co,2ndary cut,50,100

A2.1,A5.2,A6.2,C4.1,Co,mKO2,50,100

A5.1,A5.2,A6.2,C1.2,Co,PEmax,50,300

A6.1,A5.2,A6.2,C1.2,Co,2ndary cut,50,100

A2.1,A5.2,A6.2,C1.2,Co,mKO2,50,100

A5.1,A5.2,A6.2,C2.2,Co,PEmax,50,300

A6.1,A5.2,A6.2,C2.2,Co,2ndary cut,50,100

A2.1,A5.2,A6.2,C2.2,Co,mKO2,50,100

A5.1,A5.2,A6.2,C3.2,Co,PEmax,50,300

A6.1,A5.2,A6.2,C3.2,Co,2ndary cut,50,100

A2.1,A5.2,A6.2,C3.2,Co,mKO2,50,100

A5.1,A5.2,A6.2,C4.2,Co,PEmax,50,300

A6.1,A5.2,A6.2,C4.2,Co,2ndary cut,50,100

A2.1,A5.2,A6.2,C4.2,Co,mKO2,50,100

B1.2,B5.2,C3.2,B1.1,Poly,0u+ (pGW0077),72.9,200

B2.2,B6.2,C4.2,B2.1,Poly,1u- (pGW0080),50,200

B3.2,C1.2,C5.2,B3.1,Poly,1u+ (pGW0079),50,200

B4.2,C2.2,C6.2,B4.1,Poly,0u- (pGW0078),73.7,200

B1.2,B5.2,C3.2,B1.2,Poly,0u+ (pGW0077),72.9,200

B2.2,B6.2,C4.2,B2.2,Poly,1u- (pGW0080),50,200

B3.2,C1.2,C5.2,B3.2,Poly,1u+ (pGW0079),50,200

B4.2,C2.2,C6.2,B4.2,Poly,0u- (pGW0078),73.7,200

D5.2,D6.2,A6.3,D1.1,Single,mNG,75,300

D5.2,A1.3,B1.3,D2.1,Co,mNG,75,150

A2.1,A1.3,B1.3,D2.1,Co,mKO2,50,150

D1.2,A2.3,B2.3,D3.1,Single,pEH018,64.2,250

D2.2,A3.3,B3.3,D4.1,Single,pEH019,53.6,250

D3.2,A4.3,B4.3,D5.1,Single,pEH020,125.5,250

D4.2,A5.3,B5.3,D6.1,Single,pEH021,127.8,250'''
    ...
    for a in range(len(uL_DNA)):
        ...
        if DNA_vol >= 20:
            right_pipette.transfer(
                ...
                source = source,
                dest = dest,
                mix_before = (3, 20), # mixes source well before aspiration 3 times with 25 uL volume
                blow_out = True,
